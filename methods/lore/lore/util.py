...
def recognize_features_type(df, class_name):    
    integer_features = list(df.select_dtypes(include=['int8','int16','int32','int64']).columns)
    double_features = list(df.select_dtypes(include=['float16','float32','float64']).columns)
